...
|---|---|---|
| `rodoo-core` | `odoo/api.py`, `odoo/exceptions.py` | Environment, registry, erros |
| `rodoo-orm` | `odoo/orm/` | Models, fields, domains → PostgreSQL (sqlx) |
| `rodoo-http` | `odoo/http.py` | Servidor axum, JSON-RPC 2.0, sessões |
| `rodoo-qweb` | `ir_qweb.py` | Engine de templates QWeb (XML) |
| `rodoo-modules` | `odoo/modules/` | Manifests, grafo de dependências, loading |
| `rodoo-server` | `odoo-bin` | Binário `rodoo` (CLI + bootstrap) |
